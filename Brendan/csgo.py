...
#-------------------------------------------------FUNCTIONS-------------------------------------------------#
# http://api.steampowered.com/ISteamUser/ResolveVanityURL/v0001/?key=AF90EFF02499BB3CDDFFF28629DEA47B&vanityurl=brendane2002
...
# http://api.steampowered.com/ISteamUserStats/GetGlobalAchievementPercentagesForApp/v0002/?gameid=4000&format=json

#--------URL Functies--------#
def URL1(username):                                                                                                                                 #SteamID
    URL1    =   f'http://api.steampowered.com/ISteamUser/ResolveVanityURL/v0001/?key={API_key}&vanityurl={username}'
    return URL1
def URL2(steam_id):                                                                                                                                 #GameLibary Username
